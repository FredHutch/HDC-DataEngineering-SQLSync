...
select
  ...
  ,'HDCPIsActive' as TargetActiveColumn
  ,'HDCPCreateDate' as TargetCreateDateColumn
  ,'HDCPUpdateDate' as TargetUpdateDateColumn
  ,'HDCPStagingTime' as SourceUpdateDateColumn
...
select
  ...
  ,'HDCPBeginDate' as TargetBeginDateColumn
  ,'HDCPEndDate' as TargetEndDateColumn
  ,'HDCPCreateDate' as TargetCreateDateColumn
  ,'HDCPUpdateDate' as TargetUpdateDateColumn
  ,'HDCPStagingTime' as SourceUpdateDateColumn
  ,0 as CleanUpSourceAfterRun
...
,DateColumn datetime
,HDCPStagingTime datetime not null default(getdate())
,HDCPIsActive bit
,HDCPCreateDate datetime
,HDCPUpdateDate datetime
)
go
...
,NvarcharColumn nvarchar(400)
,DateColumn datetime
,HDCPStagingTime datetime not null
,HDCPBeginDate datetime
,HDCPEndDate datetime
,HDCPCreateDate datetime
,HDCPUpdateDate datetime
,constraint UnitTest_TargetTable2PK primary key clustered (TargetTableID, HDCPBeginDate)
)
go
